...
public class Templates {
	...
	static {
		...
		HyperLinkBuilder link = hyperLink("https://www.facebook.com/JooSBeeN");
		dynamicReportsComponent = cmp
				.horizontalList(
						cmp.image(Templates.class.getResource("image/miempresa.PNG")).setFixedDimension(60, 60),
						cmp.verticalList(
								cmp.text(".: MI EMPRESA :.").setStyle(bold22CenteredStyle)
										.setHorizontalTextAlignment(HorizontalTextAlignment.LEFT),
								cmp.text("https://www.facebook.com/JooSBeeN").setStyle(italicStyle).setHyperLink(link)))
				.setFixedWidth(300);
